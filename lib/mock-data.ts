...
export const mockEvidence: Evidence[] = [
  {
    evidence_id: 'ev1',
    case_id: 'c1',
    uploaded_by: 'Ibrahim Musa',
    file_name: 'cctv_footage_lekki.mp4',
    file_type: 'Video',
    description: 'CCTV footage from GTBank entrance showing suspects entering at 14:22',
    custody_notes: 'Transferred from bank security department. Original copy retained by bank.',
    uploaded_at: '2026-06-20T09:10:00Z',
  },
  {
    evidence_id: 'ev2',
    case_id: 'c1',
    uploaded_by: 'Ibrahim Musa',
    file_name: 'suspect_vehicle_photo.jpg',
    file_type: 'Image',
    description: 'Partial plate number visible on getaway vehicle captured at nearby filling station',
    custody_notes: 'Downloaded from filling station owner\'s personal phone.',
    uploaded_at: '2026-06-20T09:15:00Z',
  },
  {
    evidence_id: 'ev3',
    case_id: 'c2',
    uploaded_by: 'Chinedu Eze',
    file_name: 'witness_statement_school.pdf',
    file_type: 'Document',
    description: 'Written statement from school gate security guard',
    custody_notes: 'Signed original filed at Wuse II Station.',
    uploaded_at: '2026-06-18T14:30:00Z',
  },
  {
    evidence_id: 'ev4',
    case_id: 'c6',
    uploaded_by: 'Chioma Nwosu',
    file_name: 'forensic_report_ph.pdf',
    file_type: 'Document',
    description: 'Forensic pathology report indicating cause and estimated time of death',
    custody_notes: 'Received from Port Harcourt State Hospital forensics unit.',
    uploaded_at: '2026-06-20T05:05:00Z',
  },
  {
    evidence_id: 'ev5',
    case_id: 'c4',
    uploaded_by: 'Adaeze Okafor',
    file_name: 'email_headers.pdf',
    file_type: 'Document',
    description: 'Email headers from fraudulent CEO impersonation emails',
    custody_notes: 'Exported by company IT department. Hash verified.',
    uploaded_at: '2026-06-20T07:30:00Z',
  },
  {
    evidence_id: 'ev6',
    case_id: 'c4',
    uploaded_by: 'Adaeze Okafor',
    file_name: 'wire_transfer_records.pdf',
    file_type: 'Document',
    description: 'Bank transfer records showing fraudulent wire instructions',
    custody_notes: 'Obtained via formal request to First Bank Nigeria.',
    uploaded_at: '2026-06-20T07:35:00Z',
  },
  {
    evidence_id: 'ev7',
    case_id: 'c4',
    uploaded_by: 'Adaeze Okafor',
    file_name: 'server_access_log.pdf',
    file_type: 'Document',
    description: 'Server access logs showing unauthorized email account access from foreign IP',
    custody_notes: 'Digital forensics image created. Original server isolated.',
    uploaded_at: '2026-06-20T07:40:00Z',
  },
]
...
export const mockSuspects: Suspect[] = [
  {
    suspect_id: 's1',
    case_id: 'c1',
    full_name: 'Unknown Male A',
    alias: 'The Tall One',
    age: 30,
    gender: 'Male',
    address: 'Unknown',
    identifying_marks: 'Scar on left cheek, approximately 5cm. Estimated height 6\'1".',
    status: 'At Large',
  },
  {
    suspect_id: 's2',
    case_id: 'c1',
    full_name: 'Unknown Male B',
    alias: null,
    age: 25,
    gender: 'Male',
    address: 'Unknown',
    identifying_marks: 'Tattoo on right forearm. Wore red cap during incident.',
    status: 'At Large',
  },
  {
    suspect_id: 's3',
    case_id: 'c6',
    full_name: 'Emeka Chibuike',
    alias: 'Bullet',
    age: 34,
    gender: 'Male',
    address: 'No. 5 Creek Road, Diobu, Port Harcourt',
    identifying_marks: 'Missing right index finger. Tribal marks on both cheeks.',
    status: 'In Custody',
  },
  {
    suspect_id: 's4',
    case_id: 'c7',
    full_name: 'Samuel Adewale Ojo',
    alias: null,
    age: 45,
    gender: 'Male',
    address: '12 Association Avenue, Lekki Phase 1, Lagos',
    identifying_marks: 'None noted. Carries fake land registry documents.',
    status: 'In Custody',
  },
  {
    suspect_id: 's5',
    case_id: 'c12',
    full_name: 'Unknown — IP traced to Benin Republic',
    alias: null,
    age: 0,
    gender: 'Unknown',
    address: 'IP: 197.210.xx.xx (Cotonou, Benin Republic)',
    identifying_marks: 'Cybercrime suspect. Physical identity not yet established.',
    status: 'At Large',
  },
]
...
export const mockWitnesses: Witness[] = [
  {
    witness_id: 'w1',
    case_id: 'c1',
    full_name: 'Mrs. Blessing Obi',
    contact: '+234-801-555-1001',
    statement: 'I was at the teller queue when three men in masks entered. One fired into the ceiling. They spoke Yoruba and Igbo. The getaway car was a black Toyota Sienna, partial plate MUS-4**.',
    relationship_to_case: 'Bank customer present during robbery',
  },
  {
    witness_id: 'w2',
    case_id: 'c1',
    full_name: 'Security Guard Yusuf Abdullahi',
    contact: '+234-802-555-1002',
    statement: 'They forced me to the ground at gunpoint. I noticed one of the men had a scar on his left cheek. They were in the bank for about 8 minutes before leaving through the rear entrance.',
    relationship_to_case: 'GTBank security guard on duty',
  },
  {
    witness_id: 'w3',
    case_id: 'c2',
    full_name: 'Mr. Tunde Bakare',
    contact: '+234-803-555-1003',
    statement: 'I saw a girl matching the description near the school gate around 3:15 PM. She appeared to be talking to a man in a grey Honda Accord. She did not look distressed.',
    relationship_to_case: 'School gate security guard',
  },
  {
    witness_id: 'w4',
    case_id: 'c6',
    full_name: 'Mrs. Grace Amadi',
    contact: '+234-804-555-1004',
    statement: 'I heard a loud argument from the direction of the abandoned house around 11 PM on the 13th. I did not go outside to investigate. I heard a vehicle drive away at high speed shortly after.',
    relationship_to_case: 'Neighbour living adjacent to crime scene',
  },
  {
    witness_id: 'w5',
    case_id: 'c4',
    full_name: 'Mr. Felix Okonkwo',
    contact: '+234-805-555-1005',
    statement: 'I received an email purportedly from the CEO requesting an urgent transfer. The email domain was slightly misspelled — "companyy.com" instead of "company.com". I only noticed after the transfer was made.',
    relationship_to_case: 'Company finance manager who executed the transfer',
  },
]
